...
btn_home.addEventListener('click', ()=>{
    ...
    btn_about.style.backgroundColor='#fff';
    btn_project.style.backgroundColor='#fff';
    btn_contact.style.backgroundColor='#fff';
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  downloadButton.addEventListener("click", function () {
    ...
    downloadLink.setAttribute("href", "CV/Rymark-Recaplaza.pdf");
